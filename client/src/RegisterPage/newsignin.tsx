            ...
            <div
                ...
                <div
                    ...
                    <div style={{ margin: "20px" }}>
                        ...
                        <SubTitle>
                            Daily videos on your favourite topics, <br></br>summarised.
                        </SubTitle>
                ...
                <div style={{ display: "flex", flexDirection: "column", justifyContent: "left" }}>
                    ...
                    <div style={{ display: "flex" }}>
                        <Panel>
                            ...
                            <Text>
                                Choose something from our comprehensive library of topics or
                                customise your own.
                            </Text>
                        </Panel>
                        ...
                        <Panel>
                            ...
                            <Text>
                                We process the transcripts of your videos to give you a clear
                                written summary of the full video, in plain English.
                            </Text>
                        </Panel>
                    </div>
                    <div></div>
